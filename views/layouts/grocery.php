...
<div class="agileits_header">
    ...
    <div class="product_list_header">
        <button type="button" onclick="getCart()" class="button" data-toggle="modal" data-target="#modal-cart">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="cartClear()" class="btn btn-danger">Очистить корзину</button>
                    </div>
                </div>
            </div>
        </div>
