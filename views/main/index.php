...
<div class="top-brands">
    <div class="container">
        ...
        <div class="agile_top_brands_grids">
            <?php foreach( $isOffer as $offer):?>
            <div class="col-md-3 top_brand_left">
                <div class="hover14 column">
                    <div class="agile_top_brand_left_grid">
                        <div class="agile_top_brand_left_grid_pos">
                            <!-- <img src="images/offer.png" alt=" " class="img-responsive" /> -->
                            <?= HelpersHtml::img('@web/images/offer.png', ['alt' => 'offer', 'class' => 'img-responsive']);  ?>
                        </div>
                            ...
                            <figure>
                                <div class="snipcart-item block">
                                    <div class="snipcart-thumb">
                                        ...
                                        <?= HelpersHtml::img("@web/products/{$offer->img}", ['alt' => $offer->title]);?>
                                        </a>
                                        <p><?= $offer->title ?></p>
                                        <h4>$<?= $offer->price ?> <span>$
                                    ...
                                    <a href="<?= \yii\helpers\Url::to(['cart/add', 'id'=> $offer->id ])  ?>"
                                            class="batton add-to-cart", data-id="<?=$offer->id?>">Add to cart</a>
